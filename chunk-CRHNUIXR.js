...
`),e()()()()(),o(21,"div",10),r(22,"sample-po-modal-labs"),e(),r(23,"hr")),l&2&&(d(5),_("po-icon "+n.sampleCodeButtonIcon),d(),M(" ",n.sampleCodeButtonLabel,""),d(),s("ngClass",A(4,ve,n.hideSampleCodeTabs)))},dependencies:[k,P,v,x,me],encapsulation:2})}return i})();var Pe=["optionsForm"],ce=(()=>{class i{poNotification;form;poModal;accompaniment="";fruits;orderDetail="";close={action:()=>{this.closeModal()},label:"Close",danger:!0};confirm={action:()=>{this.proccessOrder()},label:"Confirm"};accompanimentOptions=[{value:"chocolate",label:"Chocolate"},{value:"hazeinut",label:"Hazelnut"},{value:"milk",label:"Milk"}];fruitsOptions=[{value:"orange",label:"Orange"},{value:"apple",label:"Apple"},{value:"pineapple",label:"Pineapple"},{value:"graple",label:"Grape"},{value:"strawberry",label:"Strawberry"}];constructor(m){this.poNotification=m}closeModal(){this.form.reset(),this.poModal.close()}confirmFruits(){this.proccessOrder()}restore(){this.form.reset()}openQuestionnaire(){this.poModal.open()}proccessOrder(){this.form.invalid?this.poNotification.warning("Choose the items to confirm the order."):(this.confirm.loading=!0,setTimeout(()=>{this.poNotification.success(`Your order confirmed: ${this.fruits}, with accompaniment: ${this.accompaniment}.`),this.confirm.loading=!1,this.closeModal()},700))}static \u0275fac=function(l){return new(l||i)(D(X))};static \u0275cmp=h({type:i,selectors:[["sample-po-modal-fruits-salad"]],viewQuery:function(l,n){if(l&1&&(O(Pe,7),O(C,7)),l&2){let p;L(p=V())&&(n.form=p.first),L(p=V())&&(n.poModal=p.first)}},standalone:!1,decls:14,vars:8,consts:[["optionsForm","ngForm"],["p-title","Options",3,"p-primary-action","p-secondary-action"],[1,"po-row"],["name","checkboxGroup","p-label","Fruits:","p-required","",1,"po-md-12",3,"ngModelChange","ngModel","p-options"],["name","accompaniment","p-label","Accompaniment:","p-required","",1,"po-md-12",3,"ngModelChange","ngModel","p-options"],["name","orderDetail","p-label","Details:","p-rows","8",1,"po-md-12",3,"ngModelChange","ngModel"],[3,"p-disabled-align"],["p-danger","true","p-label","Close",3,"p-click"],["p-label","Clear",3,"p-click"],["p-kind","primary","p-label","Confirm",3,"p-click"],["p-label","Buy fruits salad",3,"p-click"]],template:function(l,n){if(l&1){let p=w();o(0,"po-modal",1)(1,"form",null,0)(3,"div",2)(4,"po-checkbox-group",3),E("ngModelChange",function(a){return c(p),f(n.fruits,a)||(n.fruits=a),u(a)}),e()(),o(5,"div",2)(6,"po-combo",4),E("ngModelChange",function(a){return c(p),f(n.accompaniment,a)||(n.accompaniment=a),u(a)}),e()(),o(7,"div",2)(8,"po-textarea",5),E("ngModelChange",function(a){return c(p),f(n.orderDetail,a)||(n.orderDetail=a),u(a)}),e()()(),o(9,"po-modal-footer",6)(10,"po-button",7),g("p-click",function(){return c(p),u(n.closeModal())}),e(),o(11,"po-button",8),g("p-click",function(){return c(p),u(n.restore())}),e(),o(12,"po-button",9),g("p-click",function(){return c(p),u(n.confirmFruits())}),e()()(),o(13,"po-button",10),g("p-click",function(){return c(p),u(n.openQuestionnaire())}),e()}l&2&&(s("p-primary-action",n.confirm)("p-secondary-action",n.close),d(4),S("ngModel",n.fruits),s("p-options",n.fruitsOptions),d(2),S("ngModel",n.accompaniment),s("p-options",n.accompanimentOptions),d(2),S("ngModel",n.orderDetail),d(),s("p-disabled-align",!1))},dependencies:[R,W,q,I,N,T,H,Z,oe,C,K],encapsulation:2})}return i})();var we=i=>({"docs-sample-code-tabs":i}),ue=(()=>{class i{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(l){return new(l||i)};static \u0275cmp=h({type:i,selectors:[["sample-po-modal-fruits-salad-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,n){l&1&&(r(0,"br"),o(1,"blockquote",0)(2,"label",1),t(3,"PO Modal - Fruits Salad"),e(),o(4,"a",2),g("click",function(){return n.toggleSampleCodeTabs()}),r(5,"span"),t(6),e()(),o(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),t(12,"sample-po-modal-fruits-salad/sample-po-modal-fruits-salad.component.html"),e(),o(13,"pre",7),t(14,`<po-modal p-title="Options" [p-primary-action]="confirm" [p-secondary-action]="close">
