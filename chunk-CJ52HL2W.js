import{C as B,L as M,M as w,ca as W,da as z,ea as X}from"./chunk-KIGXQRPH.js";import{t as j}from"./chunk-FWCPSRFG.js";import"./chunk-RN62NJ3T.js";import{Aa as o,Ba as t,Ca as s,Dd as A,Fd as R,Ga as I,Ha as c,Hd as _,K as S,Kb as q,R as h,S as g,Ta as e,Va as H,Xa as v,Ya as P,Za as C,ab as T,be as V,fa as l,ga as E,kc as O,la as u,lc as N,ma as x,mc as k,nc as F,oc as L,pb as D,ua as d,xa as y}from"./chunk-647TYMBO.js";var U=(()=>{class n{http;headerParam;requestMessage;status;errorMessage=`{
    "code": "401",
...
...
`),t()(),o(160,"blockquote")(161,"p"),e(162,"Ap\xF3s a valida\xE7\xE3o no "),o(163,"em"),e(164,"interceptor"),t(),e(165,", os par\xE2metros ser\xE3o removidos do cabe\xE7alho da requisi\xE7\xE3o. "),t()()()())},encapsulation:2})}return n})();var K=(()=>{class n{route;router;sub;hidePoWebSample=!0;samplesLength=1;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(a,r){this.route=a,this.router=r}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(a=>{let r=a.view;this.activeTab=r||"doc",this.hidePoWebSample=this.samplesLength===0})}changeTab(a){this.router.navigate([],{queryParams:{view:a},queryParamsHandling:"merge"}),this.activeTab=a}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(r){return new(r||n)(E(A),E(R))};static \u0275cmp=u({type:n,selectors:[["ng-component"]],standalone:!1,decls:6,vars:4,consts:[["p-title","Http Interceptor",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(r,i){r&1&&(o(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),c("p-click",function(){return i.changeTab("doc")}),s(3,"sample-po-http-interceptor-doc"),t(),o(4,"po-tab",3),c("p-click",function(){return i.changeTab("web")}),s(5,"sample-po-http-interceptor-labs-view"),t()()()),r&2&&(d("p-actions",i.actions),l(2),d("p-active",i.activeTab==="doc"),l(2),d("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"))},dependencies:[B,M,w,G,J],encapsulation:2})}return n})();var ne=[{path:"",component:K}],Q=(()=>{class n{static \u0275fac=function(r){return new(r||n)};static \u0275mod=x({type:n});static \u0275inj=S({imports:[_.forChild(ne),_]})}return n})();var ye=(()=>{class n{static \u0275fac=function(r){return new(r||n)};static \u0275mod=x({type:n});static \u0275inj=S({imports:[X,Q]})}return n})();export{ye as DocPoHttpInterceptorModule};
